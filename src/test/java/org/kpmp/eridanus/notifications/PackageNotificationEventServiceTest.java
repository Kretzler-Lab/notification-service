...
public class PackageNotificationEventServiceTest {
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	@Test
	public void testSendNotifyEmailStateChangeEvent_successState() throws Exception {
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	@Test
	public void testSendNotifyEmailStateChangeEvent_failState() throws Exception {
		StateChangeEvent packageEvent = new StateChangeEvent();
		packageEvent.setOrigin("upload.kpmp.org");
